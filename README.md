...
* Open the folder, and download the latest firmware (click .bin file > Raw > File > Save Page As)
* Power the device
...
* Download the latest firmware from this folder (click .bin file > Raw > File > Save Page As)
